# app.py
# Radix — Component-first Chinese character explorer (Ultimate Final Version)
...
# --- Session-state filter caching for speed ---
...
def apply_dynamic_css():
    ...
    /* Detail View Character Button - Huge & Elegant */
    ...
    .splash-wrap {max-width: 1200px; margin: 0 auto; padding: 40px 20px 20px 20px;}
    .splash-card {
        background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%);
        border: 2px solid #dee2e6;
        border-radius: 28px;
    ...
    .splash-title {font-size: 2.8em; font-weight: 900; line-height: 1.2; color: #111;}
    .splash-sub {margin-top: 20px; font-size: 1.3em; color: #495057; line-height: 1.7;}
    </style>
    """
...
def main():
    ...
    if st.session_state.show_inputs:
        ...
        # Detail View - Smart Priority Ordering
